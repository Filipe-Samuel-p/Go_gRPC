...
type Output struct {
	...
	Averege       float64                `protobuf:"fixed64,2,opt,name=averege,proto3" json:"averege,omitempty"`
...
func (x *Output) GetAverege() float64 {
	if x != nil {
		return x.Averege
	}
	return 0
...
const file_src_proto_calc_service_proto_rawDesc = "" +
	...
	"\aaverege\x18\x02 \x01(\x01R\aaverege\x12\x14\n" +
